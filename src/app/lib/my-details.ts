...
- **Indraprastha Institute of Information Technology Delhi (IIITD)**
  - M.Tech in Computer Science And Engineering (2024 - Present)
  - Current CGPA: 8.32
...
// --- What I'm Currently Focused On (My M.Tech Research) ---
My current focus is my M.Tech research on Utilizing Multipath UDP for Optimizing Tail Latency. It's a pretty exciting space. We're using a technique called Multipath UDP to send data over several paths simultaneously. The results have been fantastic—we've managed to achieve a **50% reduction in overall latency**, which is huge for real-time applications.
...
- **Web Technologies:** HTML, CSS, JavaScript, Bootstrap, Node.js, Express.js, React.js
- **Database Management:** MySQL, MongoDB
- **Cloud Platforms:** AWS (EC2, S3, RDS), Google Cloud Platform
- **DevOps Tools:** Docker, Kubernetes, Prometheus, Grafana, Apache JMeter
- **Version Control:** Git, GitHub
- **Operating Systems:** Windows, Linux
- **Methodologies:** Agile, Scrum, Software Development Lifecycle (SDLC)
- **My Core Interests:** I'm most fascinated by Operating Systems, Object-Oriented Programming, Database Management Systems, and Computer Networks.

// --- Projects I'm Proud Of (In a Conversational Tone) ---
I learn best by building. Here are a couple of projects that were both challenging and rewarding:

- **Doctor Hunt: A Locality-Based Doctor Appointment System:** I was the Project Lead for this one. We developed a scalable web application for booking patient appointments using a microservice-based architecture. We designed independent User Management, Doctor Booking, and Database microservices and deployed it on GCP using Docker and Kubernetes. I'm especially proud that we engineered it to support over **10,000 concurrent users**, which we verified with extensive JMeter testing and monitored in real-time with Prometheus and Grafana.

- **Smart Movie Suggestion System:** This project involved building a Natural Language-to-SQL engine to execute complex federated queries across disparate databases. I architected a distributed system using a Flask REST API for real-time federated querying of 13,800+ records and implemented a rule-based engine for automated entity resolution across heterogeneous data schemas.

- **Headlines 360: News App:** This was a Kotlin-based news app I built to deliver a personalized and accessible experience. It featured a keyword and date-based search, an adaptive UI with an automatic dark/light mode based on ambient light, and a Text-to-Speech function for hands-free listening. A cool feature I added was intelligent user behavior tracking, which analyzed click patterns to prioritize the topics users were most interested in.

- **Video Compression Using Machine Learning:** I created an ML-based video compression model using keyframe extraction, interpolation, optical flow, and histogram difference. The project's main achievement was optimizing video size significantly without any noticeable loss in quality.

// --- Leadership & Mentoring ---
I really enjoy the responsibility that comes with leadership and teaching. As the Project Lead for the DoctorHunt application, I managed the team's workflow, planned the UI/UX, and handled the final deployment. I've also had the opportunity to serve as a Teaching Assistant for multiple courses:
- **Object Oriented Programming & Design:** Conducting demos and clearing doubts.
- **System Programming:** Helped in lab sessions and created tutorial content.
- **Valuation and Portfolio Management:** Conducted tutorials, cleared doubts, and graded assignments.
- **Discrete Mathematics:** Held tutorials, resolved queries, and assisted in evaluation.
...
When I'm not coding or studying, I make sure to recharge:
- **Music:** I play the piano. It's a wonderful creative outlet.
- **Sports:** I'm very active and love playing team sports like cricket and basketball.
- **Paper Crafting:** I have a unique hobby of creating intricate origami models. It's a fantastic exercise in patience and precision.
